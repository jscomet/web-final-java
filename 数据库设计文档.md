...
| role | INT | 是 | - | 用户角色：0-学生、1-教师、2-管理员、3-游客 |
...
### 8. assignment_submissions（作业提交表）
存储学生提交的作业。
...
## 主要关联关系
1. user -> courses: 一个教师可以创建多个课程
2. courses -> course_materials: 一个课程可以包含多个课件
3. courses -> assignments: 一个课程可以包含多个作业
4. user -> course_enrollments: 一个学生可以注册多个课程
5. assignments -> assignment_submissions: 一个作业可以有多个提交记录
6. courses -> discussions: 一个课程可以有多个讨论
7. courses -> study_notes: 一个课程可以有多个学习笔记
8. user -> question_bank: 一个用户可以创建多个题目
9. self_tests -> test_questions -> question_bank: 试卷通过中间表关联多个题目
